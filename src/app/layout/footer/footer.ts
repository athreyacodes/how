...
@Component({
  ...
  template: `
    <footer class="site-footer">
      <p class="credit">© {{ year }} {{ AUTHOR.name }}</p>
      <nav class="elsewhere" aria-label="Elsewhere">
        <a class="home-link" [href]="AUTHOR.url" target="_blank" rel="noopener noreferrer me"
          >athreya.codes</a
        >
...
export class Footer {
  ...
  protected readonly iconLinks = AUTHOR.links.filter(
